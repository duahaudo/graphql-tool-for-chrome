...
export const introspectionQueryName = getOperationAST(parse(introspectionQuery)).name.value; // Some GraphQL services do not support subscriptions and fail an introspection
